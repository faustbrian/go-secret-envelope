...
run_gate() {
    ...
    case "${selected}" in
        ...
        licenses)
            ...
            if [[ "${module_path}" != "github.com/faustbrian/go-secret-envelope" &&
                "${module_path}" != github.com/faustbrian/go-secret-envelope/* ]]; then
            ...
            run_go_tool \
                ...
                go-licenses \
                check ./... \
                --ignore "github.com/faustbrian/go-secret-envelope"
            ;;
        sbom)
            applicable security || { skip_not_applicable security; return; }
